...
export default function Blog() {
  const posts = [
    { title: 'Romania\'s Labor Shortage: Why Asian and African Workers Are the Solution', excerpt: 'Romania has lost millions of workers to Western European emigration. We explore how Asian and African recruitment is filling the gap.', date: 'Coming Soon', category: 'Industry Insights' },
    ...
    { title: 'Understanding Romanian Work Permits for Non-EU Workers', excerpt: 'A comprehensive guide to the aviz de muncă process, timelines, and requirements for Asian and African workers.', date: 'Coming Soon', category: 'Legal & Compliance' },
