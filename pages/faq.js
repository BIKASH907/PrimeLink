...
export default function FAQ() {
  ...
  const faqs = [
    { category: 'For Employers', items: [
      ...
      { q: 'What does your service cost?', a: 'Our service is free for Romanian employers. We charge a €2,500 per-candidate placement fee to our B2B recruitment partners in Asia and Africa who supply the candidates. Employers pay zero recruitment fees.' },
    ...
    { category: 'For Workers', items: [
      ...
      { q: 'Which countries do you recruit from?', a: 'We primarily recruit from Nepal, India, Bangladesh, Sri Lanka, Philippines, Pakistan, Kenya, Nigeria, Ethiopia, and more. We may expand to other Asian and African countries in the future.' },
    ]},
