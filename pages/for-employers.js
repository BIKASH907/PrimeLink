        ...
        <div className="container">
          <div className="two-col">
            ...
            <div className="two-col-text">
              ...
              <p>Primelink Human Capital sources skilled and semi-skilled workers from Nepal, India, Bangladesh, Sri Lanka, Philippines, Pakistan, Kenya, Nigeria, Ethiopia, and more — countries with large, young, motivated workforces eager for European employment.</p>
        ...
        <div className="container">
          ...
          <div className="grid-3">
            {[
              ...
              { icon: '💰', title: 'Cost-Effective', desc: 'Zero recruitment cost for Romanian employers. We handle sourcing, documentation, work permits, and placement. Our fees are charged to our B2B recruitment partners in Asia and Africa.' },
