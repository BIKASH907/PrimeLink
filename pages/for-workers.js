...
export default function ForWorkers() {
  return (
    <Layout title="For Workers" description="Find legitimate jobs in Romania. We help workers from Nepal, India, Bangladesh, Sri Lanka, Philippines, Pakistan, Kenya, Nigeria, Ethiopia, and more secure legal employment in Europe.">
        ...
        <div className="container">
          <div className="two-col">
            <div className="two-col-text">
              ...
              <p>Primelink Human Capital is a Romanian-registered company (CUI: 54386335) that helps workers from Nepal, India, Bangladesh, Sri Lanka, Philippines, Pakistan, Kenya, Nigeria, Ethiopia, and more find real, well-paying jobs in Romania.</p>
