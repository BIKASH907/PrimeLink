        ...
        <div className="container">
          <div className="grid-2" style={{ gap: '50px' }}>
            {[
              ...
              { icon: '🌏', title: 'Deep Asian and African Networks', desc: 'Our founder has deep roots in Asia and Africa with established recruitment partnerships across Nepal, India, Bangladesh, Sri Lanka, Kenya, Nigeria, Philippines, Pakistan, Kenya, Nigeria, Ethiopia, and more. We understand both cultures.' },
